...
<div id="wrapper">
  ...
  <div style="padding: 100px"><!--product-->
    <div class="container">
      <div class="row">
 ...
 ";
  ...
  echo "</div>";
        ...
        ?>
              ...
              <a href="bangsize.html" style="color: black" class="chonsize"><i>Hướng dẫn chọn size</i></a>
            
      </div>
      <form action="giohang.php" method="get">
        <?php echo "<input type='hidden' name='id' value='".$_GET['id']."' >" ?>
      <button id="BUTTON_1" type="submit" style="margin:  10px 200px" >
                THÊM VÀO GIỎ
      </button>
      </form>
    </div>
