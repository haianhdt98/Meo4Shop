...
<div id="wrapper">
  ...
  <div class="container" style="padding: 100px 0 0 0"><!--giỏ hàng-->
    ...
    <div class="row">
      <div class="col-xs-9">
        <div class="panel panel-info">
          ...
          <div class="panel-heading"><!--Title-->
            <div class="panel-title">
              <div class="row">
                ...
                <div class="col-xs-6">
                  <a href="../Index.php">
                    <button type="button" class="btn btn-primary btn-sm btn-block" style="background: black">
          ...
          <div class="panel-body"><!--Thông tin-->
            <div class="row">
 ...
 ";
  ...
  echo "</div>";
        ...
        ?>
          ...
          <div class="panel-footer"> <!-- Tổng tiền-->
            <div class="row text-center">
              
              <div class="col-xs-3">
                <a href="thongtinthanhtoan.html"><button type="button" class="btn btn-success btn-block" style="background: black">
                    Thanh toán
                  </button></a>
              </div>
            </div>
